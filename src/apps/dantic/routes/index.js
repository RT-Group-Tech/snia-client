...
const routes = [
    ...
    },
    {
        ...
        children: [{
                path: "",
                component: () =>
                    import ("@/apps/dantic/ui/pages/dashboard"),
            ...
            },
            {
                ...
                component: () =>
                    import ("@/apps/dantic/ui/pages/ipa-ita-register"),
            ...
            },
            {
                ...
                component: () =>
                    import ("@/apps/dantic/ui/pages/ipa-view"),
                name: "ipa-view-route",
                meta: {
                    authRequired: true,
                },
            },
            {
                ...
                component: () =>
                    import ("@/apps/dantic/ui/pages/ita-view"),
                name: "ita-view-route",
                meta: {
                    authRequired: true,
                },
