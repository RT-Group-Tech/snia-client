  ...
  methods: {
    loadCharts() {
      ...
      Circles.create({
        id: "circles-1",
        radius: 45,
        value: this.dashboard.ipasCount,
        maxValue: 26,
        width: 7,
        text: this.dashboard.ipasCount,
      ...
      Circles.create({
        id: "circles-2",
        radius: 45,
        value: this.dashboard.itasCount,
        maxValue: 145,
        width: 7,
        text: this.dashboard.itasCount,
      ...
      Circles.create({
        id: "circles-3",
        radius: 45,
        value: this.dashboard.agentsCount / 100,
        maxValue: 100,
        width: 7,
        text: this.dashboard.agentsCount,
